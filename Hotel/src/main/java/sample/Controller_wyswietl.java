...
public class Controller_wyswietl {
    ...
    public void initialize() throws IOException {
        JSONObject wyslij = new JSONObject("{wyswietl_rezerwacje:wyswietl_rezerwacje}");
        Serwer_pol wyslanie = new Serwer_pol(wyslij);

        JSONObject odbierz = wyslanie.wysylanie();
        JSONArray array = odbierz.getJSONArray("wyswietl_rezerwacje");
